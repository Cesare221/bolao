# Script para criar o plano de implementa��o
$content = @"
# BOL�O SUCT - Plano de Implementa��o

> **Para agentes:** Use superpowers:subagent-driven-development ou superpowers:executing-plans

**Objetivo:** Construir aplica��o mobile-first de bol�o para jogos do Brasil na Copa
...
## Tarefa 3: Criar Servi�o de API

**Arquivos:**
- Criar: src/services/footballApiService.js

- [ ] **Passo 1: Servi�o isolado**
...
git add . && git commit -m "feat: adiciona servi�o de api football"

---

## Tarefa 4: Fun��es Utilit�rias

**Arquivos:**
- Criar: src/utils/scoring.js
- Criar: src/utils/dateHelpers.js

- [ ] **Passo 1: Regras de pontua��o**
...
git add . && git commit -m "feat: adiciona utilit�rios"

---

## Tarefa 5: Componentes Reutiliz�veis
...
git add . && git commit -m "feat: adiciona componentes reutiliz�veis"
...
- [ ] **Passo 1-5: Criar p�ginas**

- [ ] **Passo 6: Commit**

git add . && git commit -m "feat: adiciona p�ginas"
...
$content | Out-File -FilePath "C:\Users\Usuario\Desktop\PROJETOS\Bolao\docs\superpowers\plans\2026-06-29-bolao-suct-implementation.md" -Encoding UTF8